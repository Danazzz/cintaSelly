...
if ($_SESSION['count'] != "" AND  $_SESSION['choose_bank'] != "") {
        ...
        <div class="row">
            <div class="col-sm-12 mt-5">
                ...
                <div class="d-flex align-items-center">
                    <img src="img/book3.png" alt="" style="margin-right: 20px;" />
                    <div>
                ...
                <form action="" method="post">
                    ...
                    <input type="text" class="form-control text-center d-none" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="jmltxt" placeholder="Konversi (RP)" id="jmltxt" readonly><br>
